...
class LoginPageForOkLocators(BasePage):
...
#новый класс с наследованием BasePage
    ...
    #создаем функцию проверки страницы,передаем self чтобы он мог узнать все параметры, функции своего класса и родительского класса
        self.find_element(LoginPageForOkLocators.LOGIN_FIELD)
        ...
        self.find_element(LoginPageForOkLocators.LOGIN_TAB)
        self.find_element(LoginPageForOkLocators.LOGIN_BUTTON)
        self.find_element(LoginPageForOkLocators.PASSWORD_FIELD)
        self.find_element(LoginPageForOkLocators.LOGIN_BUTTON_QR_CODE)
        self.find_element(LoginPageForOkLocators.FORGOT_PASSWORD_BUTTON)
        self.find_element(LoginPageForOkLocators.REGISTRATION_BUTTON)
        self.find_element(LoginPageForOkLocators.REGISTRATION_BUTTON_BY_VK)
...
# Страницы не смешиваем
    ...
    #создаем функцию инициирующую клик по полю войти без заполнения логина или пароля
        ...
        self.find_element(LoginPageForOkLocators.LOGIN_BUTTON).click()
    ...
    def get_error_text(self):
        ...
        return self.find_element(LoginPageForOkLocators.ERROR_TEXT).text
    ...
    def send_keys_login(self, text_for_send):
        self.find_element(LoginPageForOkLocators.LOGIN_FIELD).send_keys(text_for_send)
